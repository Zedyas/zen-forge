...
export const commandDefinitions: readonly CommandDefinition[] = [
  ...
  { id: 'file.exportPdf', label: 'Export as PDF…', menu: 'file', scope: ['sheets', 'docs'], target: 'renderer' },
  { id: 'file.print', label: 'Print…', menu: 'file', accelerator: 'CmdOrCtrl+P', scope: ['sheets', 'pdf', 'docs'], target: 'renderer', separatorBefore: true },
