...
export const commandDefinitions: readonly CommandDefinition[] = [
  ...
  { id: 'view.zoomOut', label: 'Zoom Out', menu: 'view', accelerator: 'CmdOrCtrl+-', scope: ['pdf'], target: 'renderer' },
  { id: 'view.actualSize', label: 'Actual Size', menu: 'view', accelerator: 'CmdOrCtrl+0', scope: ['pdf'], target: 'renderer' },
